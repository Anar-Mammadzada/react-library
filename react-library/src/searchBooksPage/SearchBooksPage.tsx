                ...
                <div className="row mt-5">
                    <div className="col-6">
                        <div className="d-flex">
                            <input className="from-control me-2" type="search" placeholder="Search" aria-labelledby="Search" 
                    ...
                    <div className="col-4">
                        <div className="dropdown">
                            ...
                            id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">{categorySelection}</button>
